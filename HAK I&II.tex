...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!30!white]
\begin{example}
Let $0$ be the zero object of $A$. Note that the category $\mathcal{E}_0$ is homotopy equivalent to the category $S=iso \mathcal{A}$: consider the functor $S\to \mathcal{E}_0$ that sends an object $C$ to the exact sequence $A\xrightarrow{=}A\twoheadrightarrow 0$. This is an equivalence of categories, and thus is a homotopy equivalence. 
\end{example}
\end{tcolorbox}
